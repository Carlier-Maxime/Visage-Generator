...
class Viewer(Renderer):
    def __init__(self, vertex: list, textures, landmark: list, faces: list, show_joints: bool = False, show_vertices: bool = False, show_markers: bool = True, other_objects: list = None, device="cuda", window_size=[1024,1024], cameras = None, rotation:list=[0,0,0]):
        """
        Args:
        ...
        """
        Renderer.__init__(self, window_size[0], window_size[1], device, rotation=rotation)
        self._device = device
        self._vertex = vertex
